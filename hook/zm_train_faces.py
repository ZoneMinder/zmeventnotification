...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "-s", "--size", type=int, help="resize amount (if you run out of memory)"
    )
    ap.add_argument(
        "-d", "--debug", help="enables debug on console", action="store_true"
    )
    ap.add_argument(
        "-bd", "--baredebug", help="enables debug on console", action="store_true"
    )
    ...
    zmes, g = proc_conf(args=args, type_="zmes")
