...
DETECTION_SCRIPT="/usr/bin/detect_yolo.py --monitor $2 --eventid $1 --config ${CONFIG_FILE}"
#DETECTION_SCRIPT="/usr/bin/detect_hog.py --monitor $2 --eventid $1 --config ${CONFIG_FILE}"
